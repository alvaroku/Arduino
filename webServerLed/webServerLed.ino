...
String processor(const String& var){
  ...
  if(var == "BUTTONPLACEHOLDER"){
    ...
    buttons += "<h4>Output - GPIO 23</h4><label class=\"switch\"><input checked type=\"checkbox\" onchange=\"toggleCheckbox(this)\" id=\"23\" " + outputState(4) + "><span class=\"slider\"></span></label>";
